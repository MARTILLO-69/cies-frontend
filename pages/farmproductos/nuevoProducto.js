            ...
            <div className='col-12 md:col-12'>
                <div className='card p-fluid'>
                    ...
                    <div className="field">
                        ...
                        <Calendar id="fecha_caducidad" name="fechacaducidad" value={producto.fechacaducidad} onChange={onDateChange} dateFormat="yy-mm-dd" placeholder={getDefaultDate()} showIcon />
                    </div>
