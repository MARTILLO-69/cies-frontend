    ...
    async function actualizarProducto() {
        if (product.nombre_medicamento.trim() !== "" &&
            ...
            product.fechacaducidad) {
                try {
                    const response = await actualizar(product.id_medicamento ,product.nombre_medicamento, proveedor ,categoria, product.precio, product.cantidad,formatDate(product.fechacaducidad));
                ...
                <div className='card'>
                    ...
                    <Dialog visible={productUpdateDialog} style={{width: '450px'}} header='Nuevo Producto' modal className='p-fluid' footer={productUpdateDialogFooter} onHide={hideDialog}>
                        ...
                        <div className="field">
                            ...
                            <Calendar id="fecha_caducidad" name="fechacaducidad" value={product.fechacaducidad} onChange={onDateChange} dateFormat="yy-mm-dd" placeholder={getDefaultDate()} showIcon />
                        </div>
                    </Dialog>
