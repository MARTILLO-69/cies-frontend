...
import { listarVentas,listarMedicamentos, registrar, actualizar, eliminar, eliminarVarios } from '../../services/apiVentas';
...
const Ventas = () => {
    ...
    const header = (
        <div className="flex flex-column md:flex-row md:justify-content-between md:align-items-center">
            ...
            <Button label="Eliminar" icon="pi pi-trash" severity="danger" onClick={confirmDeleteSelected} disabled={!selectedSales || !selectedSales.length} />
        ...
        <div className="grid crud-demo">
            <div className="col-12">
                <div className="card">
                    ...
                    <Dialog visible={saleUpdateDialog} style={{ width: '450px' }} header="Actualizar Venta" modal className="p-fluid" footer={saleUpdateDialogFooter} onHide={hideDialog}>
                        <div className="field">
                            <label htmlFor="nombreMedicamento">Medicamento Disponibles</label>
                            <Dropdown value={listboxValue} onChange={(e) => setListboxValue(e.value)} filterPlaceholder='Buscar medicamento' options={medicamentos} optionLabel="nombre_medicamento" filter />
                        </div>
                        ...
                        <div className="field" col>
                            ...
                            <Calendar id="fecha_venta" name="fecha_venta" value={sale.fecha_venta} onChange={onDateChange} showIcon />
                        </div>
